...
def load_wav_to_torch(full_path, sampling_rate):
    ...
    if sr != sampling_rate:
        data = torchaudio.transforms.Resample(sr, sampling_rate).forward(data)
...
def get_hparams(init=True):
  ...
  parser.add_argument('-m', '--model', type=str, required=True,
                      help='Model name')
  parser.add_argument('-f', '--training_files', type=str, required=True,
                      help='dataset name')
  ...
  parser.add_argument('-bs', '--batch_size', type=int, required=True,
                      help='batch size')
  parser.add_argument('-speak', '--n_speakers', type=int, required=True,
                      help='batch size')
  args = parser.parse_args()
  model_dir = os.path.join("vits/checkpoints", args.model)
